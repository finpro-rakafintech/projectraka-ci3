...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?= base_url('vendor/theme');?>/logo.png">
  ...
  <body>
      ...
      <a class="navbar-brand" href="#">
        ...
        <div class="collapse navbar-collapse " id="navbarCollapse">
          ...
          <form class="form-inline mt-2 mt-md-0">
            <a href="" class="btn btn-outline-success my-2 my-sm-" type="submit">Sign In</a> | 
            <a href="" class="btn btn-outline-warning my-2 my-sm-0" type="submit">Regitser</a>
          </form>
        </div>
      </nav>
    </header>
    ...
    <script>window.jQuery || document.write('<script src="<?= base_url('vendor');?>/assets/js/vendor/jquery-slim.min.js"></script>')</script>
