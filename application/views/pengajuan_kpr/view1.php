...
<div class="tab-content" id="pills-tabContent">
  ...
  <div class="form-group">
    <label for="exampleFormControlSelect1">Kantor Cabang</label>
  ...
  <div class="form-group">
    <label for="exampleFormControlSelect1">Harga Property</label>
    <select class="form-control" id="exampleFormControlSelect1">
  ...
  <div class="form-group">
    <label for="jenis-kredit">Jenis Kredit</label>
    <input class="form-control " type="text" placeholder="Masukan Jenis Kredit">
  </div>
  <div class="form-group">
    <label for="nilai-pengajuan">Nilai Pengajuan</label>
  ...
  <div class="form-group">
    <label for="nilai-pengajuan">Uang Muka</label>
    <input class="form-control " type="text" placeholder="Eg: Rp. 500.000.000">
  </div>
  <div class="form-group">
    <label for="exampleFormControlSelect1">Cara Pembayaran Angsuran</label>
    <select class="form-control" id="exampleFormControlSelect1">
